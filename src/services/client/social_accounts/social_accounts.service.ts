...
export const socialAccountService = {
    createSocialAccount: async (userId: number | string, socialData: SocialAccountData) => {
    ...
    deleteSocialAccount: async (platformId: number | string) => {
        const response = await fetch(
            `${BASE_URL}/social-media/${platformId}`,
            {
                method: "DELETE",
                credentials: "include",
            }
    ...
    updateSocialAccount: async (platformId: number | string, updateData: UpdateSocialAccountData) => {
        const response = await fetch(
            `${BASE_URL}/social-media/${platformId}`,
            {
                method: "PUT",
