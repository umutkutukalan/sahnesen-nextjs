...
const ProfileSidebar = () => {
  ...
  return (
    <>
      <div
        className={`fixed inset-0 top-16 bg-black/40 z-70 transition-opacity duration-300 ${
      ...
      <aside
        className={`hidden lg:flex h-[calc(100vh-64px)] fixed top-16 flex-col justify-between bg-white z-80 transition-all duration-300 overflow-hidden ${
          isProfileSidebarOpen
