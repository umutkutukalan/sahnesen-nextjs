...
const Sidebar = () => {
  ...
  return (
    <aside
      className={`hidden lg:flex h-[calc(100vh-64px)] fixed top-16 flex-col justify-between bg-white z-40 transition-all duration-500 ease-in-out overflow-hidden shrink-0 ${
        isSidebarOpen
