...
const PageAbout = ({
  ...
  return (
    <div
      className="w-full relative bg-white flex items-end justify-center p-0"
      style={{ height: "64px" }}
    >
      <div className="flex items-center w-full md:max-w-5xl justify-between border-b border-gray-100">
        {!isProfilePage && (
          <div className="w-full flex items-center gap-6 pt-2 px-1">
            {/* Fuaye Sekmesi */}
            <Link
              href="/"
        ...
        <div className="w-full flex items-center gap-6 pt-2">
          <ul
            className={`w-full flex ${isProfilePage ? "justify-start pl-10" : "justify-end"} gap-6 overflow-x-auto scrollbar-hide`}
          >
            <button
              type="button"
              className={`pb-4 flex items-center gap-1.5 cursor-pointer transition-all ${
